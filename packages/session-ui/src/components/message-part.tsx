  ...
  return (
    <Show when={value()}>
      <Markdown
        ...
        downloadDirectory={props.downloadDirectory}
          ...
          <Show
            ...
            fallback={
              <Markdown
                ...
                onOpenPreview={data.openPreview}
              />
            }
          >
            <PacedMarkdown
    ...
    return (
      ...
      >
        <Show when={props.output}>
          ...
          >
            <Markdown text={props.output!} downloadDirectory={data.directory} onOpenPreview={data.openPreview} />
          </div>
        </Show>
      </BasicTool>
    )
